...
% hyperspectral intensity matrix I from the bottom using the algorithm
...
%
% Input:
%    I    - hyperspectral intensity matrix with broad background. It
%           consists of Nr submatrices (individual hyperspectral images)
...
%  Save   - logical parameter specifying whether to save results of BGF.
...
%
% Output:
%    I    - hyperspectral intensity matrix with removed quasi-slowly varied
%           background.
%
% 
